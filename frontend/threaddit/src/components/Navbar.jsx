          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `duration-500 group flex space-x-1 group cursor-pointer ${
                isActive && "text-theme-red-coral"
              }`
            }>
            <Svg type="home" className="w-6 h-6" />
            <h2 className="font-semibold group-hover:text-theme-red-coral">
              Home
            </h2>
          </NavLink>
          <NavLink
      ...
      {isAuthenticated ? (
        <div className="flex items-center md:space-x-6">
          ...
          <button
            ...
            <Svg
              type="circle-logout"
              className="hidden w-6 h-6 duration-300 rotate-180 md:block hover:scale-110"
            />
