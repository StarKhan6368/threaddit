...
export default function InfinitePostsLayout({
  ...
  const { data, isFetching, hasNextPage, fetchNextPage } = useInfiniteQuery({
    ...
    queryFn: async ({ pageParam = 0 }) => {
      return await axios
        .get(
          `https://elegant-manifestation-production.up.railway.app/api/${linkUrl}?limit=${20}&offset=${
            pageParam * 20
        ...
        <header className="flex justify-between items-center">
          ...
          <ul className="hidden space-x-2 list-none md:flex">
            ...
            <li
              ...
              onClick={() => {
                mixpanel.track('Duration Change', { duration: 'week' });
                handleDurationChange('week');
              }}
            >
              Week
            </li>
            <li
              ...
              onClick={() => {
                mixpanel.track('Duration Change', { duration: 'month' });
                handleDurationChange('month');
              }}
            >
              Month
            </li>
            <li
              ...
              onClick={() => {
                mixpanel.track('Duration Change', { duration: 'alltime' });
                handleDurationChange('alltime');
              }}
            >
              All
            </li>
