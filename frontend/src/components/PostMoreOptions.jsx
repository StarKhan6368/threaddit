...
export default function MoreOptions({
  ...
  async function handleDelte() {
    if (isAuthenticated) {
      await axios.delete(`https://elegant-manifestation-production.up.railway.app/api/post/${postInfo?.id}`);
  ...
  async function handleSaved() {
    ...
    if (postSaved) {
      await axios.delete(`https://elegant-manifestation-production.up.railway.app/api/posts/saved/${postInfo?.id}`);
      setPostSaved(false);
    } else {
      await axios.put(`https://elegant-manifestation-production.up.railway.app/api/posts/saved/${postInfo?.id}`);
      setPostSaved(true);
    }
