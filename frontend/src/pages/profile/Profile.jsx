        ...
        <div className="flex flex-col items-center w-full bg-theme-cultured">
          <div className="flex flex-col p-2 w-full bg-white rounded-md md:p-5">
            <div className="flex flex-col flex-1 justify-between items-center p-2 w-full rounded-md md:flex-row md:rounded-full bg-theme-cultured">
              <img src={data.avatar || avatar} className="object-cover w-24 h-24 bg-white rounded-full cursor-pointer md:w-36 md:h-36" alt="" onClick={() => { mixpanel.track('user_profile_clicked', { username: data.username, user_id: data.id }); setAction(
              <img src={data.avatar || avatar} className="object-cover w-11/12 max-h-5/6 md:w-max md:max-h-screen" alt="" />
              ); }}
              />
